...
GLOBAL OPTIONS:
   ...
   --buildx.driver-opt.network value  buildx driver-opt network. docker buildx create --driver-opt network={} [$DRONE_BUILDX_DRIVER_OPT_NETWORK]
   --buildx.args value                buildx args. docker buildx create {} [$PLUGIN_BUILDX_ARGS]
   ...
   --tags value                       build tags (default: "latest", "1,423,ko") [$PLUGIN_TAG, $PLUGIN_TAGS] [.tags]
